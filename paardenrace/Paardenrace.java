...
public class Paardenrace extends JFrame implements ActionListener {
    ...
    private void startRace(Graphics g) {
         ...
         * kunt initialiseren.
         */
        h1 = new Paard("Winner",Color.blue, new ImageIcon("C:\\Users\\BramWeenink\\Pictures\\mario2.png"));
        h2 = new Paard("Sinner",Color.red, new ImageIcon("C:\\Users\\BramWeenink\\Pictures\\mario2.png"));
        h3 = new Paard("Spinner",Color.yellow, new ImageIcon("C:\\Users\\BramWeenink\\Pictures\\mario2.png"));
        h4 = new Paard("ChickenDinner",Color.green, new ImageIcon("C:\\Users\\BramWeenink\\Pictures\\mario2.png"));
        h5 = new Paard("ChickenKicker",Color.orange, new ImageIcon("C:\\Users\\BramWeenink\\Pictures\\mario2.png"));
